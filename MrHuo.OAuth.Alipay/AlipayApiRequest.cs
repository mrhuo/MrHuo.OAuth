...
namespace MrHuo.OAuth.Alipay
{
    public class AlipayApiRequest
    {
        ...
        private async Task<T> InvokeAsync<T>(string httpMethod, string apiMethod, Dictionary<string, string> param = null)
        {
            ...
            param = AlipaySignTool.Sign(param, PrivateRSAKey);
        ...
        public Task<T> Post<T>(string apiMethod, Dictionary<string, string> param = null)
        {
    ...
    internal class AlipayApiErrorResponse
    {
    ...
    {
        [JsonPropertyName("error_response")]
        public AlipayApiErrorResponse ErrorResponse { get; set; }
